                  ...
                  <ul className="options-list">
                    ...
                    {selectedAnswers[idx] && (
                      <div className="feedback">
                        {selectedAnswers[idx] === 'correct'
                          ? '✓ Correct Answer!'
                          : '✗ Incorrect. Review the lesson material.'}
                      </div>
                    )}
                  </ul>
                </div>
      ...
      <div className="toast-container">
        <div id="copyToast" className="toast" role="alert" aria-live="assertive" aria-atomic="true">
          <div className="toast-content">
            ...
            <button type="button" className="toast-close" data-bs-dismiss="toast" aria-label="Close">×</button>
          </div>
        </div>
      </div>

      <footer className="app-footer">
        <p>CourseGPT © 2025 • AI-Powered Educational Content Platform</p>
      </footer>
